                    ...
                    open: function (opts) {
                        ...
                        $q.all({
                            ...
                            $dialog.html((options.overlay ?
                                '<div class="ngdialog-overlay"></div><div class="ngdialog-content container" role="document">' + template + '</div>' :
                                '<div class="ngdialog-content container" role="document">' + template + '</div>'));
